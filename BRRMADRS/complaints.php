  ...
  <script src="bootstrap/3.4.1/js/bootstrap.min.js"></script>
    ...
    <table id="tblID" class="display" style="width:100%" >
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<td>' ;
            echo '<a class="btn btn-info btn-lg" href="complaints.php?action=approve&complaints_id= ' . $row["complaints_id"] . '&email=' . $row["email"] . '&reference_no=' . $row["reference_no"] . '&complainant=' . $row["complainant"] . '&date_recorded=' . $row["date_recorded"] . '    ">Approve</a>';
        echo " &nbsp; ";
            echo '<a class="btn btn-danger btn-lg" href="complaints.php?action=disapprove&complaints_id= ' . $row["complaints_id"] . '&email=' . $row["email"] . '&reference_no=' . $row["reference_no"] . '&complainant=' . $row["complainant"] . '&date_recorded=' . $row["date_recorded"] . ' ">Disapprove</a>';
           echo '</td>' ;
            echo '</tr>' ;
        }
            ?>
