...
.filename
{
    ...
    <body class="skin-black">
        ...
        <form action="req_ID.php" method="POST">
            <p class ="paragraphA">Barangay ID Request Form</p>
            
            <input type = "text" name="name" placeholder="Enter Name" required aria-required="true" class="iptA">
            
            <br>
            <br>
            <input type = "email" id = "pass" name = "email" placeholder="Enter emaill address" required aria-required="true" class = "iptA"/>
            <br>
            <br>
            <input type = "text" id = "pass" name = "contactp" placeholder="Contact Person" required aria-required="true" class = "iptA"/>
            <br>
            <br>
            <input type = "text" name="contactn" placeholder="Contact no" required aria-required="true" class="iptA">
            
            <br>
            <br>
            <input type = "text" id = "pass" name = "address" placeholder="Enter address" required aria-required="true" class = "iptA"/>
            <br>
...
$rand=rand();
$query="INSERT INTO tblbrgy_id(name, contact_person, contactno, address,date_recorded,referenceno,status, email) VALUES ('$name','$cp','$cn','$address',NOW(),'$rand','pending','$email')";
