...
.filename
{
    ...
    <body class="skin-black">
        ...
        <form action="complain_form.php" method="POST">
...
$mail -> addAddress('brgy.mail.sender01@gmail.com','@gmail.com');
$mail -> addReplyTo('brgy.mail.sender01@gmail.com');
$mail-> AddCC ($email);
$mail -> isHTML(true);
$mail ->Subject ='Reference no [ '.$rand.'] - FILE COMPLAIN';
$mail -> Body = '<p> Dear '.$name. ',</p> 
                <p> Thank you for using Barangay Residents Record Management and Appoinment of Document Request System. This is to acknowledge receipt of your file complain. </p>
                ...
                <p> Until then please wait for a confimation email for the appointment of your complain</p>
                <br><br><p>Thank you</p>';
if(!$mail ->send()){
