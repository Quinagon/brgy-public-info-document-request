...
<thead background-color="#32CD32" >
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<td>' ;
            echo '<a class="btn btn-info btn-lg" href="indigency.php?action=approve&req_id= ' . $row["req_id"] . '&email=' . $row["email"] . '&reference_no=' . $row["reference_no"] . '&name=' . $row["name"] . '&date_recorded=' . $row["date_recorded"] . ' ">Approve</a>';
        echo " &nbsp; ";
            echo '<a class="btn btn-danger btn-lg" href="indigency.php?action=disapprove&req_id= ' . $row["req_id"] . '&email=' . $row["email"] . '&reference_no=' . $row["reference_no"] . '&name=' . $row["name"] . '&date_recorded=' . $row["date_recorded"] . ' ">Disapprove</a>';
           echo '</td>' ;
            echo '</tr>' ;
        }
            ?>
